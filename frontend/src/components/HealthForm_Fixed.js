...
const HealthForm = ({ user, onLogout }) => {
  ...
  // Available symptoms list (MUST MATCH BACKEND FEATURES)
          ...
          <div className="tab-panel">
            ...
            {predictions.symptoms && (
              <div className="result-card" style={{
                ...
                <div className="prediction-result">
                  ...
                  {predictions.symptoms.description && (
                    <div style={{ marginTop: '20px', padding: '15px', backgroundColor: '#f8f9fa', borderRadius: '5px' }}>
                      <h4>ℹ️ Description</h4>
                      <p>{predictions.symptoms.disease_description || predictions.symptoms.description}</p>
                    </div>
                  )}
            ...
            {predictions.skin && (
              <div className="result-card" style={{
                ...
                <div className="result-header">
                  <h3>🖼️ Skin Disease Prediction</h3>
                  <span className="risk-badge" style={{
                ...
                <div className="prediction-result">
                  <p className="main-prediction">
                    <strong>Predicted Disease:</strong> {predictions.skin.predicted_disease}
                  </p>
                  <p><strong>Confidence:</strong> {predictions.skin.confidence_percentage}</p>
                  {predictions.skin.medications && (
                    <div style={{ marginTop: '15px' }}>
                      <h4>Suggested Medications:</h4>
                      <ul>
                        {predictions.skin.medications.map((med, idx) => <li key={idx}>{med}</li>)}
                      </ul>
                    </div>
                  )}
                </div>
            ...
            {predictions.xray && (
              <div className="result-card" style={{
                ...
                <div className="prediction-result">
                  <p className="main-prediction">
                    <strong>Finding:</strong> {predictions.xray.finding}
                  </p>
                  <p><strong>Confidence:</strong> {predictions.xray.confidence_percentage}</p>
                  {predictions.xray.medications && (
                    <div style={{ marginTop: '15px' }}>
                      <h4>Suggested Medications:</h4>
                      <ul>
                        {predictions.xray.medications.map((med, idx) => <li key={idx}>{med}</li>)}
                      </ul>
                    </div>
                  )}
                </div>
